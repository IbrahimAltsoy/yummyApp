...
namespace yummyApp.Persistance.Migrations
{
    ...
    [Migration("20240703075312_mig_localDbDeployment")]
    partial class mig_localDbDeployment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("yummyApp.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("Timestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 3, 7, 53, 11, 36, DateTimeKind.Utc).AddTicks(5233));
