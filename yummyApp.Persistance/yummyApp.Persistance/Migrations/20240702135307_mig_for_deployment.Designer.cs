...
namespace yummyApp.Persistance.Migrations
{
    ...
    [Migration("20240702135307_mig_for_deployment")]
    partial class mig_for_deployment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("yummyApp.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("Timestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 2, 13, 53, 5, 479, DateTimeKind.Utc).AddTicks(3602));
